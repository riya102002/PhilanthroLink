    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Query checkUserDatabase = reference.orderByChild("ownerID").equalTo(queryIdNum.getText().toString().trim());
...
//                            Toast.makeText(ContactActivity.this, "Hello", Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                ...
                                thread.start();
                                Toast.makeText(NGOForgotPassword.this, "Recovery Mail with your Password sent to your Registered Email ID", Toast.LENGTH_SHORT).show();
                        ...
                        {
                            Toast.makeText(NGOForgotPassword.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                        }
                    }
